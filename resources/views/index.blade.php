                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-6 col-md-6">
                                <div class="business_thumb">
                                    <img src="{{ asset('img/about/business.png') }}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="expert_active owl-carousel">
                        <div class="single_expert">
                            <div class="expert_thumb">
                                <img src="{{ asset('img/experts/1.png') }}" alt="">
                            </div>
                        ...
                        <div class="single_expert">
                            <div class="expert_thumb">
                                <img src="{{ asset('img/experts/2.png') }}" alt="">
                            </div>
                            <div class="experts_name text-center">
                                <h3>Mirazul Alom</h3>
                                <span>Neurologist</span>
                        ...
                        <div class="single_expert">
                            <div class="expert_thumb">
                                <img src="{{ asset('img/experts/3.png') }}" alt="">
                            </div>
                            <div class="experts_name text-center">
                                <h3>Mirazul Alom</h3>
                                <span>Neurologist</span>
                        ...
                        <div class="single_expert">
                            <div class="expert_thumb">
                                <img src="{{ asset('img/experts/4.png') }}" alt="">
                            </div>
                            <div class="experts_name text-center">
                                <h3>Mirazul Alom</h3>
                                <span>Neurologist</span>
